    ...
    <div class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                ...
                <input id="email" type="email" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('email') border-red-500 @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
